...
import com.aleksa.notepad.Adapter.NotesListAdapter;
import com.aleksa.notepad.Database.RoomDB;
    ...
    private void filter(String newText) {
        ...
        for (Notes singleNote: notes) {
            if (singleNote.getTitle().toLowerCase().contains(newText.toLowerCase())
                    || singleNote.getNotes().toLowerCase().toLowerCase().contains(newText.toLowerCase())) {
